...
public class TiendaService implements ITiendaService {
    ...
    public Tienda edit(Long id, Tienda tienda) throws Exception {
        ...
        try{
            ...
            this.tienda.setTelefono(tienda.getTelefono());
            this.tienda.setDireccion(tienda.getDireccion());
            this.tienda.setRedes(tienda.getRedes());
            this.tienda.setProductos(tienda.getProductos());
            this.tienda.setCategoria(tienda.getCategoria());
